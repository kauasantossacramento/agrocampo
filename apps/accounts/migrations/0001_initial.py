    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('papel', models.CharField(choices=[('cliente', 'Cliente'), ('lojista', 'Lojista'), ('admin', 'Administrador')], default='cliente', max_length=20)),
                ('aceita_marketing', models.BooleanField(default=True, verbose_name='aceita receber ofertas')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('apelido', models.CharField(default='Casa', max_length=60)),
                ...
                ('referencia', models.CharField(blank=True, help_text='Ponto de referência — útil na zona rural.', max_length=180)),
                ('zona_rural', models.BooleanField(default=False)),
                ('padrao', models.BooleanField(default=False, verbose_name='endereço padrão')),
